import {
  ...
  class BQPOrbit {
	  ...
	  function createAxes () {
		...
		return [
		  { axis: "x", direction: new Vector3(0.9, 0, 0), size: size.primary, color: colors.x, line, label: "X", position: new Vector3(0, 0, 0)  },
		  { axis: "y", direction: new Vector3(0, 0, 0.9), size: size.secondary, color: colors.z, position: new Vector3(0, 0, 0)  },
		  { axis: "z", direction: new Vector3(0, 0.9, 0), size: size.primary, color: colors.y, line, label: "Z", position: new Vector3(0, 0, 0)  },
		  { axis: "-x", direction: new Vector3(-0.9, 0, 0), size: size.secondary, color: colors.x, position: new Vector3(0, 0, 0) },
		  { axis: "-y", direction: new Vector3(0, -0.9, 0), size: size.secondary, color: colors.y, position: new Vector3(0, 0, 0) },
		  { axis: "-z", direction: new Vector3(0, 0, -0.9), size: size.primary, color: colors.z, line, label: "Y", position: new Vector3(0, 0, 0) },
		];
	  }
	  ...
	  function drawLayers ( clear ) {
		...
		for(let i = 0, length = axes.length; i < length; i ++) {
		  ...
		  drawCircle(axis.position, axis.size, highlight ? "#e5e7eb" : color);
